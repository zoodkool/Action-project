...
function getUiConfig() {
  return {
    'callbacks': {
      ...
      'signInSuccessWithAuthResult': function(authResult, redirectUrl) {
        ...
        // console.log('redirect la: '+ redirectUrl);
 		    window.location.href = 'https://oauth-redirect.googleusercontent.com/r/go-link-75cab?code='+authResult.user.email+'&state='+ myParam;
        // Do not redirect.
        return false;
      }
    },
    ...
    'tosUrl': 'https://golinkco.com',
    // Privacy policy url.
    'privacyPolicyUrl': 'https://golinkco.com',
